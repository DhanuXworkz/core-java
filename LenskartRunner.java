class LenskartRunner {
	public static void main(String len[]){
		Lenskart lens = new Lenskart("vincent",2000,"transperent","medium");
		...
		Lenskart lens1 = new Lenskart("Ray ban",5000,"transperent","medium");
		...
		Lenskart lens2 = new Lenskart("Oakley",2390,"Black","Small");
		...
		Lenskart lens3 = new Lenskart("Carrera",400,"blue","Medium");
		...
		Lenskart lens4 = new Lenskart("Jacobs",400,"Transperent","Medium");
