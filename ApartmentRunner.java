class ApartmentRunner {
	...
	public static void main(String a[]){
		...
		Apartment apartment = new Apartment(1,"prestige","Whitefield",45,120,100);
		...
		Apartment apartment1 =new Apartment(2,"Prestige","RajajiNagar",43,140,104);
		...
		Apartment apartment2 = new Apartment(3,"Prestige","jpNagar",30,110,50);
		...
		Apartment apartment3 = new Apartment(4,"Dmart","RRNagar",13,50,40);
		...
		Apartment apartment4 = new Apartment(5,"Shobha","rarjinagar",25,70,40);
